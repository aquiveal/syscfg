...
RCLONE_SYNC_PATH="/mnt/Drive/Cabbery"
...
RCLONE_REMOTE="cabbery-general-thr1:drive-josb-bucket"
...
RCLONE_CMD="rclone -v sync ${RCLONE_SYNC_PATH} ${RCLONE_REMOTE} --delete-after"
